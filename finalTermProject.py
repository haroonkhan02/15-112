...
### LAYOUT 
    ...
    def getPicButtons(self,screen):
        ...
        file= font.render("(.JPEGs Only)",False,(255,255,255))
        screen.blit(file,(30,685))
    
    def getTitle(self,screen):
        pygame.font.init()
        font= pygame.font.Font("alba.ttf",40)
        textsurface= font.render('Draw It!',False,(0,153,153))
...
### COMPUTATIONAL STUFF
    ...
    def __init__(self, width=800, height=800, fps=100, title="Draw It!"):
        self.width = width
        self.height = height
        self.fps = fps
        self.title = title
